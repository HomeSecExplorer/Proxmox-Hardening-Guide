...
|-------|---------|---------|------|
| **PVE 9** | Proxmox Virtual Environment 9.x | 0.9.0 - 30 December 2025 | [`docs/pve9-hardening-guide.md`](docs/pve9-hardening-guide.md) |
| **PBS 4** | Proxmox Backup Server 4.x | 0.9.0 - 30 December 2025 | [`docs/pbs4-hardening-guide.md`](docs/pbs4-hardening-guide.md) |
| **PVE 8** | Proxmox Virtual Environment 8.x | 0.9.3 - 30 December 2025 | [`docs/pve8-hardening-guide.md`](docs/pve8-hardening-guide.md) |
| **PBS 3** | Proxmox Backup Server 3.x | 0.9.3 - 30 December 2025 | [`docs/pbs3-hardening-guide.md`](docs/pbs3-hardening-guide.md) |
